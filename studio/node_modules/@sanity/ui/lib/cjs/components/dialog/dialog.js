...
const Dialog = (0, import_react.forwardRef)(function Dialog2(props, ref) {
  ...
  const labelId = `${id}_label`;
  return /* @__PURE__ */ import_react.default.createElement(import_utils.Portal, {
    __unstable_name: portal
  }, /* @__PURE__ */ import_react.default.createElement(Root, __spreadProps(__spreadValues({}, restProps), {
    $padding: padding,
    $position: position,
