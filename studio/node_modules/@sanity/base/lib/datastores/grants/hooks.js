...
function unstable_useCheckDocumentPermission(id, type, permission) {
  // eslint-disable-next-line react-hooks/rules-of-hooks
  return (0, _reactRx.useObservable)( // eslint-disable-next-line react-hooks/rules-of-hooks
  (0, _reactRx.useAsObservable)([id, type, permission], (0, _rxjs.pipe)((0, _operators.distinctUntilChanged)(_shallowEquals.default), (0, _operators.debounceTime)(10), // eslint-disable-next-line @typescript-eslint/no-shadow
