...
var _BlockExtrasModule = _interopRequireDefault(require("./BlockExtras.module.css"));
...
function BlockExtras(props) {
  ...
  var content = /*#__PURE__*/_react.default.createElement("div", {
    className: _BlockExtrasModule.default.content,
    style: {
      height: "".concat(height, "px")
    }
  }, markers.length > 0 && /*#__PURE__*/_react.default.createElement("div", {
    className: _BlockExtrasModule.default.markers
    ...
    className: _BlockExtrasModule.default.blockActions
  ...
  var returned = isFullscreen && path && (0, _types.isKeySegment)(path[0]) ? /*#__PURE__*/_react.default.createElement(_changeIndicators.ChangeIndicatorWithProvidedFullPath, {
    className: _BlockExtrasModule.default.changeIndicator,
    compareDeep: true,
    value: block,
    hasFocus: hasFocus,
    path: [{
  ...
  return /*#__PURE__*/_react.default.createElement("div", {
    className: (0, _classnames.default)([_BlockExtrasModule.default.root, hasFocus && _BlockExtrasModule.default.hasFocus, isFullscreen && _BlockExtrasModule.default.hasFullScreen, errors.length > 0 && _BlockExtrasModule.default.withError, warnings.length > 0 && !errors.length && _BlockExtrasModule.default.withWarning])
  }, returned);
}
