...
var _PortableTextInput = _interopRequireDefault(require("../PortableTextInput"));
...
function TestInput(props) {
  ...
  var onChange = (0, _react.useCallback)(event => {
    var newValue = (0, _simplePatch.applyAll)(value, event.patches);
    setValue(newValue);
  }, [value]);
  ...
  return /*#__PURE__*/_react.default.createElement(_FormBuilderContext.default, {
    ...
    resolvePreviewComponent: _preview.resolvePreviewComponent
  }, /*#__PURE__*/_react.default.createElement(_PortableTextInput.default, {
    focusPath: focusPath,
    hotkeys: hotkeys,
    level: 1,
    markers: markers,
