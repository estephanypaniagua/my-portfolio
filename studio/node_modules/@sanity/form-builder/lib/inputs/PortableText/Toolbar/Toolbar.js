...
var _ToolbarModule = _interopRequireDefault(require("./Toolbar.module.css"));
...
function PTEToolbar(props) {
  ...
  return /*#__PURE__*/_react.default.createElement("div", {
    className: (0, _classnames.default)(_ToolbarModule.default.root, isFullscreen && _ToolbarModule.default.fullscreen) // Ensure the editor doesn't lose focus when interacting
    ...
    className: _ToolbarModule.default.blockStyleSelectContainer
  }, /*#__PURE__*/_react.default.createElement(_BlockStyleSelect.default, _extends({}, blockStyleSelectProps, {
    className: _ToolbarModule.default.blockStyleSelect,
    disabled: disabled,
    padding: "small",
    selection: selection,
    readOnly: readOnly,
    ...
    className: _ToolbarModule.default.actionMenuContainer
    ...
    className: _ToolbarModule.default.insertMenuContainer
