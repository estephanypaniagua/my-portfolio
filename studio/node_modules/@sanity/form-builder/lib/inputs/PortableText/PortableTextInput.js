...
var PortableTextInputWithRef = /*#__PURE__*/_react.default.forwardRef(function PortableTextInput(props, ref) {
  ...
  var patche$ = (0, _react.useMemo)(() => new _rxjs.Subject(), []);
  var patchObservable = (0, _react.useMemo)(() => patche$.asObservable(), [patche$]); // Handle incoming patches from withPatchSubscriber HOC
  ...
  var editorInput = (0, _react.useMemo)(() => /*#__PURE__*/_react.default.createElement(_portableTextEditor.PortableTextEditor, {
    ...
    type: "button",
    tabIndex: 0,
    className: _PortableTextInputModule.default.focusSkipper,
