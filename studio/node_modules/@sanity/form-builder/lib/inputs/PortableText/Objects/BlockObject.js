...
var _BlockObjectModule = _interopRequireDefault(require("./BlockObject.module.css"));
...
var BlockObject = _ref => {
  ...
  (0, _useScrollIntoViewOnFocusWithin.useScrollIntoViewOnFocusWithin)(elementRef, (0, _focusUtils.hasFocusWithinPath)(focusPath, value));
  var errors = markers.filter(_types.isValidationErrorMarker);
  var classnames = (0, _classnames.default)([_BlockObjectModule.default.root, focused && _BlockObjectModule.default.focused, selected && _BlockObjectModule.default.selected, errors.length > 0 && _BlockObjectModule.default.hasErrors]);
  ...
  return /*#__PURE__*/_react.default.createElement("div", {
    ...
    className: _BlockObjectModule.default.previewContainer,
    style: readOnly ? {
      cursor: 'default'
    } : {}
  }, blockPreview));
