...
var _InlineObjectModule = _interopRequireDefault(require("./InlineObject.module.css"));
...
var InlineObject = _ref => {
  ...
  var classnames = (0, _classnames.default)([_InlineObjectModule.default.root, focused && _InlineObjectModule.default.focused, selected && _InlineObjectModule.default.selected, errors.length > 0 && _InlineObjectModule.default.hasErrors]);
  ...
  return /*#__PURE__*/_react.default.createElement("span", {
    ...
    className: _InlineObjectModule.default.previewContainer,
    style: readOnly ? {
      cursor: 'default'
