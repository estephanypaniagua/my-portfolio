...
var _PortableTextInputModule = _interopRequireDefault(require("./PortableTextInput.module.css"));
...
function PortableTextSanityEditor(props) {
  ...
  var scClassNames = [_PortableTextInputModule.default.scrollContainer, ...(renderBlockActions || hasMarkers ? [_PortableTextInputModule.default.hasBlockExtras] : [_PortableTextInputModule.default.hasNoBlockExtras])].join(' ');
  var editorWrapperClassNames = [_PortableTextInputModule.default.editorWrapper].join(' ');
  var editorClassNames = [_PortableTextInputModule.default.editor, ...(renderBlockActions || hasMarkers ? [_PortableTextInputModule.default.hasBlockExtras] : [_PortableTextInputModule.default.hasNoBlockExtras])].join(' ');
  ...
  var _editor = (0, _react.useMemo)(() => /*#__PURE__*/_react.default.createElement("div", {
    className: _PortableTextInputModule.default.editorBox
  }, /*#__PURE__*/_react.default.createElement("div", {
    className: _PortableTextInputModule.default.header
  }, /*#__PURE__*/_react.default.createElement("div", {
    className: _PortableTextInputModule.default.toolbarContainer
    ...
    className: _PortableTextInputModule.default.fullscreenButtonContainer
  }, /*#__PURE__*/_react.default.createElement(_expandCollapseButton.ExpandCollapseButton, {
    isFullscreen: isFullscreen,
    onToggleFullscreen: onToggleFullscreen
  }))), /*#__PURE__*/_react.default.createElement("div", {
    className: _PortableTextInputModule.default.editorBoxContent
    ...
    className: _PortableTextInputModule.default.blockExtras
