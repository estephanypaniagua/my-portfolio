...
var DocumentListPane = /*#__PURE__*/(0, _react.memo)(function DocumentListPane(props) {
  ...
  var _pane$defaultLayout = pane.defaultLayout,
      ...
      schemaTypeName = pane.schemaTypeName,
      title = pane.title;
  ...
  var header = (0, _react.useMemo)(() => /*#__PURE__*/_react.default.createElement(_DocumentListPaneHeader.DocumentListPaneHeader, {
    index: index,
    ...
    title: title
  }), [index, initialValueTemplates, menuItems, menuItemGroups, schemaTypeName, setLayout, setSortOrder, title]);
  var content = (0, _react.useMemo)(() => /*#__PURE__*/_react.default.createElement(_DocumentListPaneContent.DocumentListPaneContent, {
    ...
    onRetry: onRetry,
    showIcons: showIcons
  }), [childItemId, error, filterIsSimpleTypeContraint, fullList, isActive, isLoading, items, layout, handleListChange, onRetry, showIcons]);
  return (0, _react.useMemo)(() => /*#__PURE__*/_react.default.createElement(_pane.Pane, {
    currentMaxWidth: 350,
    "data-index": index,
