...
var DocumentPanel = function DocumentPanel(props) {
  ...
  }), [activeView, displayed, documentId, documentSchema, editState === null || editState === void 0 ? void 0 : editState.draft, editState === null || editState === void 0 ? void 0 : editState.published, initialValue, value]); // Scroll to top as `documentId` changes

  (0, _react.useEffect)(() => {
    if (!(documentScrollElement !== null && documentScrollElement !== void 0 && documentScrollElement.scrollTo)) return;
    documentScrollElement.scrollTo(0, 0);
  }, [documentId, documentScrollElement]);
  return (0, _react.useMemo)(() => /*#__PURE__*/_react.default.createElement(_ui.Flex, {
    direction: "column",
    flex: 2,
  ...
  }, activeView.type === 'form' && /*#__PURE__*/_react.default.createElement(_PermissionCheckBanner.PermissionCheckBanner, null), /*#__PURE__*/_react.default.createElement(Scroller, {
    ...
    ref: portalRef
  }))))), [activeView.type, activeViewNode, documentId, documentScrollElement, formViewHidden, layoutCollapsed, margins, portalElement, ready, rootElement]);
};
