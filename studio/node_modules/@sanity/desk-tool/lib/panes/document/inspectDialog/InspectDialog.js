...
var viewModeSettings = _settings.deskToolSettings.forKey('inspect-view-preferred-view-mode');
...
function InspectDialogComponent(props) {
  var onViewModeChange = props.onViewModeChange,
      value = props.value,
  ...
  return /*#__PURE__*/_react.default.createElement(_ui.Dialog, {
    ...
    "aria-labelledby": "".concat(dialogIdPrefix, "tab-").concat(viewMode.id),
    flex: 1,
