...
var getStatusIndicator = (draft, published) => {
  if (published && draft) {
    return /*#__PURE__*/_react.default.createElement(_ui.Inline, {
      space: 4
    }, /*#__PURE__*/_react.default.createElement(_PublishedStatus.PublishedStatus, null), /*#__PURE__*/_react.default.createElement(_DraftStatus.DraftStatus, null));
  }

  if (published) {
    return _PublishedStatus.PublishedStatus;
  }
