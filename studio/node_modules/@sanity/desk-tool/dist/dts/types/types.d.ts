...
interface BaseResolvedPaneNode<T extends PaneNode['type']> {
    ...
    canHandleIntent?: (intentName: string, params: Record<string, string>, options: {
...
export declare type PaneChild = ((id: string, context: RouterPaneSiblingContext) => PaneChild) | Serializable<PaneChild> | Subscribable<PaneChild> | PromiseLike<PaneChild> | PaneNode;
export declare type UnresolvedPaneNode = Subscribable<PaneNode> | PromiseLike<PaneNode> | Serializable<PaneNode> | PaneNode;
export {};
