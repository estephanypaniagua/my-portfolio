...
exports.getNewDocumentModalSchemaTypes = getNewDocumentModalSchemaTypes;
...
var cachedModalActions;
var cachedSchemaTypes;
...
function getNewDocumentModalSchemaTypes() {
...
function createModalAction(templateItem) {
  ...
  if (!type) {
    throw new Error("Schema type \"".concat(tpl.schemaType, "\" not declared"));
  }
