...
var _getNewDocumentModalActions = require("../util/getNewDocumentModalActions");
...
var DefaultLayout = /*#__PURE__*/(0, _react.memo)(function DefaultLayout() {
  ...
  var renderContent = () => {
    ...
    return /*#__PURE__*/_react.default.createElement(_styles.RootFlex, {
      ...
      documentTypes: (0, _getNewDocumentModalActions.getNewDocumentModalSchemaTypes)(),
      ...
      actions: (0, _getNewDocumentModalActions.getNewDocumentModalActions)()
